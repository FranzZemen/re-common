...
export interface ScopedFactory<C> {
  register(reference: C | RuleElementModuleReference | RuleElementInstanceReference<C>, override, check?: CheckFunction, paramsArray?: any[], ec?: ExecutionContextI): C | Promise<C>;
